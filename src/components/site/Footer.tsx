      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-10">
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground">
              An independent initiative working to change the conversation around
              epilepsy through research, education, and community.
            </p>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><Link to="/posts" className="hover:text-primary">Journal</Link></li>
          ...
          <div className="md:col-span-4">
            ...
            <p className="mt-4 text-sm">
              <a href="mailto:hello@lumen.org" className="underline underline-offset-4 hover:text-primary">
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-border pt-8 text-xs text-muted-foreground md:flex-row md:items-center">
          <div className="flex flex-col gap-2 md:flex-row md:gap-6">
            ...
            <Link to="/admin" className="hover:text-primary transition-colors">Staff Login</Link>
          </div>
